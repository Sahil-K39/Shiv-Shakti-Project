...
aug1_groups = [
    (1, 5), (6, 7), (8, 12), (13, 17), (18, 25), (26, 30),
    (31, 39), (40, 44), (45, 46), (47, 48), (49, 52), (53, 58)
]

aug8_groups = [
    (1, 4), (5, 9), (10, 15), (16, 22), (23, 27), (28, 43),
    (44, 48), (49, 55), (56, 59), (60, 61), (62, 72), (73, 74),
    (75, 78), (79, 84), (85, 95), (96, 101), (102, 108), (109, 110),
    (111, 115), (116, 125)
]
...
def process_folder(folder_name, slug_prefix, name_prefix, groups):
    ...
    for i, (start, end) in enumerate(groups):
        ...
        for j, src in enumerate(group_files):
            dst_filename = f"{slug}-v4-{j+1:02d}.webp"
