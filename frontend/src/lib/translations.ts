...
export const TRANSLATIONS: Record<string, TranslationMap> = {
  en: {
    ...
    "footer.rights": "© 2026 SHIV WOMEN PROJECT. ALL RIGHTS RESERVED.",
    "footer.women": "Women",
    "footer.men": "Men",
  ...
  es: {
    ...
    "footer.transmission": "TRANSMISIÓN", "footer.desc": "Únete al Consejo para obtener acceso anticipado a colecciones y novedades mayoristas.", "footer.contact": "CONTACTAR SOPORTE", "footer.rights": "© 2026 SHIV WOMEN PROJECT. TODOS LOS DERECHOS RESERVADOS.",
  ...
  fr: {
    ...
    "footer.transmission": "TRANSMISSION", "footer.desc": "Rejoignez le Conseil pour un accès prioritaire aux nouvelles collections et mises à jour.", "footer.contact": "CONTACTER LE SUPPORT", "footer.rights": "© 2026 PROJET SHIV WOMEN. TOUS DROITS RÉSERVÉS.",
  ...
  de: {
    ...
    "footer.transmission": "ÜBERTRAGUNG", "footer.desc": "Treten Sie dem Rat bei für exklusiven Zugang zu neuen Kollektionen und Großhandels-Updates.", "footer.contact": "SUPPORT KONTAKTIEREN", "footer.rights": "© 2026 SHIV WOMEN PROJECT. ALLE RECHTE VORBEHALTEN.",
  ...
  ja: {
    ...
    "footer.transmission": "ニュースレター", "footer.desc": "新コレクションやホールセール情報へ早期アクセスするためにカウンシルに参加してください。", "footer.contact": "サポートにお問い合わせ", "footer.rights": "© 2026 SHIV WOMEN PROJECT. ALL RIGHTS RESERVED.",
  ...
  zh: {
    ...
    "footer.transmission": "专线通报", "footer.desc": "加入理事会抢先获得最新设计面世、独家面料与成衣批发资讯。", "footer.contact": "联系客服支持", "footer.rights": "© 2026 SHIV WOMEN PROJECT. 保留所有权利。",
  ...
  ru: {
    ...
    "footer.transmission": "ТРАНСМИССИЯ", "footer.desc": "Присоединяйтесь к Совету для раннего доступа к новым коллекциям и оптовым обновлениям.", "footer.contact": "СВЯЗАТЬСЯ С ПОДДЕРЖКОЙ", "footer.rights": "© 2026 SHIV WOMEN PROJECT. ВСЕ ПРАВА ЗАЩИЩЕНЫ.",
