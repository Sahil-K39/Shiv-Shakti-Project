...
export const TRANSLATIONS: Record<string, TranslationMap> = {
  en: {
    ...
    "hero.subtitle": "Core WHOLESALE COLLECTION",
    ...
    "home.coreWholesaleOpen": "Core WHOLESALE OPEN",
    ...
    "home.marquee": "Core WHOLESALE BUYING WINDOW OPEN",
    ...
    "home.coreMenswear": "Core MENSWEAR",
    ...
    "home.coreWomenswear": "Core WOMENSWEAR",
  ...
  hi: {
    ...
    "home.coreWholesaleOpen": "Core थोक खुला है",
    ...
    "home.coreWomenswear": "Core महिला संग्रह",
  ...
  ar: {
    ...
    "home.coreWomenswear": "أزياء نسائية Core",
  ...
  es: {
    ...
    "hero.subtitle": "COLECCIÓN MAYORISTA Core", "hero.title": "VANGUARDIA DECONSTRUIDA", "hero.description": "Siluetas ceremoniales, texturas rituales y arquitectura textil para el Consejo de la Luz.", "hero.cta": "EXPLORAR CATÁLOGO MAYORISTA", "hero.lookbook": "ARCHIVO DE TEMPORADA",
    "home.categories": "CATEGORÍAS", "home.coreLive": "Core EN VIVO", "home.newStuff": "*NOVEDADES", "home.wholesaleBuying": "COMPRA MAYORISTA", "home.men": "MEN", "home.women": "WOMEN", "home.armorCeremonial": "ARMADURA / CEREMONIAL", "home.deconstructed": "DECONSTRUIDO", "home.knitsHeavy": "PUNTO / PESADO", "home.knitsLight": "PUNTO / LIGERO", "home.robesCoats": "TÚNICAS Y ABRIGOS",
    ...
    "home.collection": "COLECCIÓN", "home.coreWholesaleOpen": "MAYORISTA Core ABIERTO", "home.minimumOrder": "PEDIDO MÍNIMO", "home.moqUnits": "MÍN. 20 UNIDADES / ESTILO", "home.dispatch": "ENVÍO", "home.globalExpress": "ENVÍO EXPRÉS GLOBAL",
    "home.marquee": "VENTANA DE COMPRA MAYORISTA Core ABIERTA", "home.directFromShowroom": "DIRECTO DEL SHOWROOM", "home.featuredStyles": "ESTILOS DESTACADOS", "home.all": "TODOS", "home.viewCatalogue": "VER CATÁLOGO MAYORISTA COMPLETO",
    "home.coreMenswear": "MODA MASCULINA Core", "home.menDeconstructed": "MEN", "home.menDesc": "Abrigos ceremoniales, punto deconstruido y siluetas modulares diseñadas para el movimiento.", "home.exploreMen": "EXPLORAR COLECCIÓN MEN",
    "home.coreWomenswear": "MODA FEMENINA Core", "home.womenSilhouettes": "WOMEN", "home.womenDesc": "Drapeados fluidos, algodones orgánicos y capas arquitectónicas para la conciencia moderna.", "home.exploreWomen": "EXPLORAR COLECCIÓN WOMEN",
  ...
  fr: {
    ...
    "hero.subtitle": "COLLECTION GROSSISTE Core", "hero.title": "AVANT-GARDE DÉCONSTRUITE", "hero.description": "Silhouettes cérémonielles, textures rituelles et draperies architecturales pour le Conseil de la Lumière.", "hero.cta": "EXPLORER LE CATALOGUE GROSSISTE", "hero.lookbook": "ARCHIVES SAISONNIÈRES",
    "home.categories": "CATÉGORIES", "home.coreLive": "Core EN DIRECT", "home.newStuff": "*NOUVEAUTÉS", "home.wholesaleBuying": "ACHAT EN GROS", "home.men": "MEN", "home.women": "WOMEN", "home.armorCeremonial": "ARMURE / CÉRÉMONIEL", "home.deconstructed": "DÉCONSTRUIT", "home.knitsHeavy": "MAILLES / ÉPAISSES", "home.knitsLight": "MAILLES / LÉGÈRES", "home.robesCoats": "ROBES ET MANTEAUX",
    ...
    "home.collection": "COLLECTION", "home.coreWholesaleOpen": "GROSSISTE Core OUVERT", "home.minimumOrder": "COMMANDE MINIMUM", "home.moqUnits": "MIN. 20 UNITÉS / MODÈLE", "home.dispatch": "EXPÉDITION", "home.globalExpress": "LIVRAISON EXPRESS MONDIALE",
    "home.marquee": "FENÊTRE D'ACHAT GROSSISTE Core OUVERTE", "home.directFromShowroom": "DIRECT DU SHOWROOM", "home.featuredStyles": "MODÈLES EN VEDETTE", "home.all": "TOUS", "home.viewCatalogue": "VOIR LE CATALOGUE GROSSISTE COMPLET",
    "home.coreMenswear": "MODE HOMME Core", "home.menDeconstructed": "MEN", "home.menDesc": "Manteaux cérémoniels, tricots déconstruits et silhouettes modulaires conçues pour le mouvement.", "home.exploreMen": "EXPLORER LA COLLECTION MEN",
    "home.coreWomenswear": "MODE FEMME Core", "home.womenSilhouettes": "WOMEN", "home.womenDesc": "Drapés fluides, cotons biologiques et superpositions architecturales pour la conscience moderne.", "home.exploreWomen": "EXPLORER LA COLLECTION WOMEN",
  ...
  de: {
    ...
    "hero.subtitle": "Core GROSSHANDELSKOLLEKTION", "hero.title": "DEKONSTRUIERTE AVANTGARDE", "hero.description": "Zeremonielle Silhouetten, rituelle Texturen und architektonische Drapierungen für den Rat des Lichts.", "hero.cta": "GROSSHANDELSKATALOG ENTDECKEN", "hero.lookbook": "SAISONARCHIV",
    "home.categories": "KATEGORIEN", "home.coreLive": "Core LIVE", "home.newStuff": "*NEU", "home.wholesaleBuying": "GROSSHANDELSEINKAUF", "home.men": "MEN", "home.women": "WOMEN", "home.armorCeremonial": "RÜSTUNG / ZEREMONIELL", "home.deconstructed": "DEKONSTRUIERT", "home.knitsHeavy": "STRICK / SCHWER", "home.knitsLight": "STRICK / LEICHT", "home.robesCoats": "ROBEN & MÄNTEL",
    ...
    "home.collection": "KOLLEKTION", "home.coreWholesaleOpen": "Core GROSSHANDEL OFFEN", "home.minimumOrder": "MINDESTBESTELLUNG", "home.moqUnits": "MIN. 20 EINHEITEN / STIL", "home.dispatch": "VERSAND", "home.globalExpress": "WELTWEITER EXPRESSVERSAND",
    "home.marquee": "Core GROSSHANDELSFENSTER GEÖFFNET", "home.directFromShowroom": "DIREKT AUS DEM SHOWROOM", "home.featuredStyles": "AUSGEWÄHLTE STILE", "home.all": "ALLE", "home.viewCatalogue": "GESAMTEN GROSSHANDELSKATALOG ANSEHEN",
    "home.coreMenswear": "Core HERRENMODE", "home.menDeconstructed": "MEN", "home.menDesc": "Zeremonielle Mäntel, dekonstruierte Strickwaren und modulare Silhouetten für Bewegung.", "home.exploreMen": "MEN KOLLEKTION ENTDECKEN",
    "home.coreWomenswear": "Core DAMENMODE", "home.womenSilhouettes": "WOMEN", "home.womenDesc": "Fließende Draperien, Bio-Baumwolle und architektonische Schichtungen für das moderne Bewusstsein.", "home.exploreWomen": "WOMEN KOLLEKTION ENTDECKEN",
  ...
  ja: {
    ...
    "hero.subtitle": "Core ホールセールコレクション", "hero.title": "アバンギャルドの再構築", "hero.description": "光の評議会のためにデザインされた儀礼的シルエットと上質なテクスチャー。", "hero.cta": "カタログを見る", "hero.lookbook": "アーカイブ",
    "home.categories": "カテゴリー", "home.coreLive": "Core ライブ", "home.newStuff": "*新着", "home.wholesaleBuying": "ホールセール仕入れ", "home.men": "MEN", "home.women": "WOMEN", "home.armorCeremonial": "アーマー / 儀礼", "home.deconstructed": "デコンストラクション", "home.knitsHeavy": "ニット / ヘビー", "home.knitsLight": "ニット / ライト", "home.robesCoats": "ローブ＆コート",
    ...
    "home.collection": "コレクション", "home.coreWholesaleOpen": "Core ホールセール受付中", "home.minimumOrder": "最低注文数", "home.moqUnits": "最低20点 / スタイル", "home.dispatch": "発送", "home.globalExpress": "国際エクスプレス配送",
    "home.marquee": "Core ホールセール受注窓口オープン", "home.directFromShowroom": "ショールームから直接", "home.featuredStyles": "注目のスタイル", "home.all": "すべて", "home.viewCatalogue": "ホールセールカタログ全体を見る",
    "home.coreMenswear": "Core メンズウェア", "home.menDeconstructed": "MEN", "home.menDesc": "セレモニアルコート、デコンストラクテッドニット、動きのためのモジュラーシルエット。", "home.exploreMen": "SHIVAコレクションを見る",
    "home.coreWomenswear": "Core レディースウェア", "home.womenSilhouettes": "WOMEN", "home.womenDesc": "流動的なドレープ、オーガニックコットン、モダンな意識のためのアーキテクチュラルレイヤリング。", "home.exploreWomen": "SHAKTIコレクションを見る",
  ...
  zh: {
    ...
    "hero.subtitle": "Core 批发系列", "hero.title": "解构前卫美学", "hero.description": "专为光明理事会打造的仪式感剪裁、独家理疗质感与建筑学立体垂坠设计。", "hero.cta": "浏览批发总目录", "hero.lookbook": "季度档案",
    "home.categories": "分类", "home.coreLive": "Core 上线", "home.newStuff": "*新品", "home.wholesaleBuying": "批发选购", "home.men": "湿婆 / 男装", "home.women": "萨克蒂 / 女装", "home.armorCeremonial": "概念战甲 / 典礼装", "home.deconstructed": "解构", "home.knitsHeavy": "针织 / 厚款", "home.knitsLight": "针织 / 薄款", "home.robesCoats": "长袍与外套",
    ...
    "home.collection": "系列", "home.coreWholesaleOpen": "Core 批发开放", "home.minimumOrder": "最低订量", "home.moqUnits": "最低20件 / 款式", "home.dispatch": "发货", "home.globalExpress": "全球快递配送",
    "home.marquee": "Core 批发订购窗口已开放", "home.directFromShowroom": "展厅直供", "home.featuredStyles": "精选款式", "home.all": "全部", "home.viewCatalogue": "查看完整批发目录",
    "home.coreMenswear": "Core 男装", "home.menDeconstructed": "湿婆 / 男装 — 解构战甲", "home.menDesc": "探索仪式感外套、解构针织和为运动而设计的模块化廓形。", "home.exploreMen": "探索SHIVA系列",
    "home.coreWomenswear": "Core 女装", "home.womenSilhouettes": "萨克蒂 / 女装 — 光的廓形", "home.womenDesc": "流动垂坠、有机棉面料和为现代意识打造的建筑感层次。", "home.exploreWomen": "探索SHAKTI系列",
  ...
  ru: {
    ...
    "hero.subtitle": "ОПТОВАЯ КОЛЛЕКЦИЯ Core", "hero.title": "ДЕКОНСТРУИРОВАННЫЙ АВАНГАРД", "hero.description": "Церемониальные силуэты, ритуальные текстуры и архитектурная драпировка для Совета Света.", "hero.cta": "ОТКРЫТЬ ОПТОВЫЙ КАТАЛОГ", "hero.lookbook": "СЕЗОННЫЙ АРХИВ",
    "home.categories": "КАТЕГОРИИ", "home.coreLive": "Core LIVE", "home.newStuff": "*НОВИНКИ", "home.wholesaleBuying": "ОПТОВЫЕ ЗАКУПКИ", "home.men": "ШИВА / МУЖЧИНЫ", "home.women": "ШАКТИ / ЖЕНЩИНЫ", "home.armorCeremonial": "БРОНЯ / ЦЕРЕМОНИАЛЬНОЕ", "home.deconstructed": "ДЕКОНСТРУКЦИЯ", "home.knitsHeavy": "ТРИКОТАЖ / ПЛОТНЫЙ", "home.knitsLight": "ТРИКОТАЖ / ЛЁГКИЙ", "home.robesCoats": "МАНТИИ И ПАЛЬТО",
    ...
    "home.collection": "КОЛЛЕКЦИЯ", "home.coreWholesaleOpen": "OПТ Core ОТКРЫТ", "home.minimumOrder": "МИНИМАЛЬНЫЙ ЗАКАЗ", "home.moqUnits": "МИН. 20 ЕДИНИЦ / СТИЛЬ", "home.dispatch": "ОТПРАВКА", "home.globalExpress": "МЕЖДУНАРОДНАЯ ЭКСПРЕСС-ДОСТАВКА",
    "home.marquee": "ОКНО ОПТОВЫХ ЗАКУПОК Core ОТКРЫТО", "home.directFromShowroom": "НАПРЯМУЮ ИЗ ШОУРУМА", "home.featuredStyles": "ИЗБРАННЫЕ МОДЕЛИ", "home.all": "ВСЕ", "home.viewCatalogue": "СМОТРЕТЬ ВЕСЬ ОПТОВЫЙ КАТАЛОГ",
    "home.coreMenswear": "МУЖСКАЯ МОДА Core", "home.menDeconstructed": "ШИВА / МУЖЧИНЫ — ДЕКОНСТРУИРОВАННАЯ БРОНЯ", "home.menDesc": "Церемониальные пальто, деконструированный трикотаж и модульные силуэты для движения.", "home.exploreMen": "СМОТРЕТЬ КОЛЛЕКЦИЮ ШИВА",
    "home.coreWomenswear": "ЖЕНСКАЯ МОДА Core", "home.womenSilhouettes": "ШАКТИ / ЖЕНЩИНЫ — СИЛУЭТЫ СВЕТА", "home.womenDesc": "Текучие драпировки, органический хлопок и архитектурные наслоения для современного сознания.", "home.exploreWomen": "СМОТРЕТЬ КОЛЛЕКЦИЮ ШАКТИ",
  ...
  ur: {
    ...
    "hero.subtitle": "Core ہول سیل کلیکشن", "hero.title": "جدید ایونٹ گارڈ لباس", "hero.description": "مجلس نور کے لیے شاندار تقریباتی ملبوسات اور روایتی بناوٹ۔", "hero.cta": "ہول سیل کیٹلاگ دیکھیں", "hero.lookbook": "موسمی آرکائیو",
    "home.categories": "زمرے", "home.coreLive": "Core لائیو", "home.newStuff": "*نیا", "home.wholesaleBuying": "ہول سیل خریداری", "home.men": "شیوا / مرد", "home.women": "شکتی / خواتین", "home.armorCeremonial": "بکتر / تقریباتی", "home.deconstructed": "ڈی کنسٹرکٹڈ", "home.knitsHeavy": "نٹویئر / بھاری", "home.knitsLight": "نٹویئر / ہلکا", "home.robesCoats": "چوغے اور کوٹ",
    ...
    "home.collection": "کلیکشن", "home.coreWholesaleOpen": "Core ہول سیل کھلا ہے", "home.minimumOrder": "کم از کم آرڈر", "home.moqUnits": "کم از کم 20 یونٹ / اسٹائل", "home.dispatch": "ڈسپیچ", "home.globalExpress": "عالمی ایکسپریس ڈیلیوری",
    "home.marquee": "Core ہول سیل خریداری ونڈو کھلی ہے", "home.directFromShowroom": "شو روم سے براہ راست", "home.featuredStyles": "نمایاں اسٹائلز", "home.all": "سب", "home.viewCatalogue": "مکمل ہول سیل کیٹلاگ دیکھیں",
    "home.coreMenswear": "Core مردانہ لباس", "home.menDeconstructed": "شیوا / مرد — ڈی کنسٹرکٹڈ بکتر", "home.menDesc": "تقریباتی کوٹ، ڈی کنسٹرکٹڈ نٹویئر، اور حرکت کے لیے ماڈیولر سلیوٹس۔", "home.exploreMen": "شیوا کلیکشن دیکھیں",
    "home.coreWomenswear": "Core خواتین کا لباس", "home.womenSilhouettes": "شکتی / خواتین — روشنی کے سلیوٹس", "home.womenDesc": "بہتا ہوا ڈریپنگ، آرگینک کاٹن، اور جدید شعور کے لیے آرکیٹیکچرل لیئرنگ۔", "home.exploreWomen": "شکتی کلیکشن دیکھیں",
