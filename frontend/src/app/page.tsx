...
export default function Home() {
  ...
  return (
    <div className="w-full bg-[#fbfaf8] text-black min-h-screen">
      ...
      {/* 1. Hero Section (Psylo Style) */}
      <section className="relative w-full h-[85vh] min-h-[600px] bg-black overflow-hidden flex items-center justify-center pt-[80px]">
        {/* Background Image */}
      ...
      {/* 2. Shop by Category (Psylo Style Circles) */}
      ...
      {/* 3. New Arrivals (Psylo Style Horizontal Track) */}
      ...
      {/* 4. The Ethos Grid (Previously at the top) */}
      <section className="w-full max-w-[1400px] mx-auto px-4 md:px-8 py-16 md:py-24 border-t border-black/10">
